...
function SignIn() {
  ...
  return (
    ...
    className="relative w-screen h-screen bg-gradient-radial from-orange-100 to-orange-50 flex items-center justify-center overflow-hidden animate-pulse-bg">
      
      <div style={{backgroundColor : 'var(--card-bg)', color: 'var(--text-primary)'}} className="relative z-10 bg-white shadow-2xl rounded-2xl p-12 w-full max-w-sm flex flex-col items-center text-center backdrop-blur-sm">
