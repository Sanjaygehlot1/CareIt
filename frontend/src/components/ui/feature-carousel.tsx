              ...
              return (
                ...
                >
                  <button
                    ...
                    className={cn(
                      "relative flex items-center gap-4 px-6 md:px-10 lg:px-8 py-3.5 md:py-5 lg:py-4 rounded-full transition-all duration-700 text-left group border flex-shrink-0 whitespace-nowrap",
                      isActive
                        ? "bg-white text-[#ea580c] border-white z-10"
                  ...
                  >
                    <div
                      className={cn(
                        ...
                        isActive ? "text-[#ea580c]" : "text-white/40"
                      )}
                    >
                      <feature.icon size={18} strokeWidth={2} />
                    </div>

                    <span className="font-semibold text-sm md:text-[15px] tracking-tight uppercase">
                      {feature.label}
                    </span>
                  </button>
                </motion.div>
                ...
                >
                  ...
                  <AnimatePresence>
                    {isActive && (
                      ...
                      >
                        <div className="bg-background px-4 py-1.5 rounded-full text-[11px] font-semibold uppercase tracking-widest w-fit shadow-lg mb-3 border border-border/50" style={{ color: 'var(--text-primary)'}}>
